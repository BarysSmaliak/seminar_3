...
и информация в репозитории возвращается к той версии, в которой была создана ветка на которую мы перешли.
...
Для того, чтобы удалить не нужную более ветку (например, когда вся информация из неё перелита в основную ветку), необходимо воспользоваться командой 
